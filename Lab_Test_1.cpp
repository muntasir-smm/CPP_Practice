...
void clearInput() /* this func clear any input error */
{
    cin.clear();
    cin.ignore(numeric_limits<streamsize>::max(), '\n'); // array size er cheye besi input dile beshi gulo ignore korbe
}
...
void printArray(const vector<float> &arr, int n)
{
...
int main()
{
    vector<float> arr; /* for Dynamic array size. user er theke array size neya jabe joto boro issa */
    int n, choice;
    ...
    do
    {
        ...
        if (cin.fail()) /* for input error handling */
        {
            clearInput();
            cout << "Invalid choice!\n";
            continue;
